...
//   const services = [
//     {
//       icon: <FaIdCard className="text-blue-400 text-4xl" />,
//       title: "PAN Card",
//       description: "Quick and hassle-free PAN card application & updates.",
//         button: "Apply"
//     },
//     {
//       icon: <FaFileAlt className="text-green-400 text-4xl" />,
//       title: "Income Certificate",
//       description: "Get your income certificate issued with ease.",
//         button: "Apply"
//     },
//     {
//       icon: <FaUserCheck className="text-purple-400 text-4xl" />,
//       title: "Caste Certificate",
//       description: "Apply for caste certificate with complete guidance.",
//         button: "Apply"
//     },
//     {
//       icon: <FaUniversity className="text-orange-400 text-4xl" />,
//       title: "Domicile Certificate",
//       description: "Proof of residence for official and legal purposes.",
//         button: "Apply"
//     },
//     {
//       icon: <FaMobileAlt className="text-pink-400 text-4xl" />,
//       title: "Mobile & DTH Recharge",
//       description: "Fast and secure recharge for all major operators.",
//         button: "Apply"
//     },
//     {
//       icon: <FaMoneyBillWave className="text-teal-400 text-4xl" />,
//       title: "Bill Payments",
//       description: "Pay electricity, water, and gas bills instantly.",
//         button: "Apply"
//     },
//     {
//       icon: <FaHome className="text-red-400 text-4xl" />,
//       title: "Property Registration",
//       description: "Hassle-free assistance for property registration.",
//         button: "Apply"
//     },
//     {
//       icon: <FaLaptopHouse className="text-indigo-400 text-4xl" />,
//       title: "Online Form Filling",
//       description: "Apply for government schemes & forms online.",
//       button: "Apply"
//     },
//   ];

//   return (
//     <div className="bg-black min-h-screen pt-24 pb-16 px-6">
//       <div className="max-w-7xl mx-auto">
//         {/* Heading */}
//         <h1 className="text-4xl md:text-5xl font-extrabold text-center text-white mb-6 tracking-wide">
//           Our <span className="text-blue-500">Services</span>
//         </h1>
//         <p className="text-center max-w-2xl mx-auto text-lg text-gray-400 mb-12">
//           We offer a wide range of online services to make your life easier.  
//           From essential documents to daily bill payments — everything under one roof.
//         </p>
...
//             <div
//               key={index}
//               className="bg-gradient-to-b from-gray-900 to-gray-800 border border-gray-700 backdrop-blur-md rounded-2xl p-6 text-center gap-2 shadow-lg hover:shadow-blue-600/30 hover:scale-105 transition-all duration-300"
//             >
//               <div className="flex justify-center mb-4">{service.icon}</div>
...
//               <button className="px-4 py-2 mt-2 text-white bg-green-500 rounded-xl" onClick={()=>{}}>{service.button}</button>
//             </div>
//           ))}
//         </div>
//       </div>
